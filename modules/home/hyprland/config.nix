{ ... }:
{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      # # binds for Lid Switch events on Laptops
      bindl = [
        ",switch:on:Lid Switch, exec, hyprctl keyword monitor 'eDP-1, disable'"
        ",switch:off:Lid Switch, exec, hyprctl keyword monitor 'eDP-1, 2880x1800@59.95, 0x0, 1.5'"
      ];
    ...
    extraConfig = "
      monitor=eDP-1, 2880x1800@59.95, 0x0, 1.5
      monitor=DP-8, 1920x1080@59.94, -1080x-1440, 1, transform, 3
      monitor=DP-9, 2560x1440@59.95, 0x-1440, 1
      monitor=DP-10, 2560x1440@59.95, 2560x-1440, 1
